...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_KUJINOUGHT]  = gMonIcon_Kujinought,
    [SPECIES_MLLOY]       = gMonIcon_Mlloy,
    [SPECIES_BITEMARE]    = gMonIcon_Bitemare,
    [SPECIES_GEMGEIST]    = gMonIcon_Gemgeist,
    [SPECIES_TOXIBRO]     = gMonIcon_Toxibro,
    [SPECIES_GEOWATT]     = gMonIcon_Geowatt,
    [SPECIES_CLODSIRE]    = gMonIcon_Clodsire,
    [SPECIES_CURSOLA]     = gMonIcon_Cursola,
    [SPECIES_CORSOREEF]   = gMonIcon_Corsoreef,
    ...
    [SPECIES_GEKOPON]     = gMonIcon_Gekopon,
    [SPECIES_PLACEHOLDERMON] = gMonIcon_Placeholdermon,
    [SPECIES_VOLTREL]     = gMonIcon_Voltrel,
    [SPECIES_VOLTREAN]    = gMonIcon_Voltrean,
    ...
    [SPECIES_KROLUCADA]   = gMonIcon_Krolucada,
    [SPECIES_KROLUCARD]   = gMonIcon_Krolucard,
