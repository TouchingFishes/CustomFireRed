...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(IRIS, gTrainerFrontPic_Iris, 0x800),
    TRAINER_SPRITE(BARRY, gTrainerFrontPic_Barry, 0x800),
    TRAINER_SPRITE(PAXTON, gTrainerFrontPic_Paxton, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(IRIS, gTrainerPalette_Iris),
    TRAINER_PAL(BARRY, gTrainerPalette_Barry),
    TRAINER_PAL(PAXTON, gTrainerPalette_Paxton),
