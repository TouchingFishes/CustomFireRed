const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(KUJINOUGHT, gMonFrontPic_Kujinought),
    ...
    SPECIES_SPRITE(CORSOREEF, gMonFrontPic_Corsoreef),
    ...
    SPECIES_SPRITE(GEKOPON, gMonFrontPic_Gekopon),
    SPECIES_SPRITE(PLACEHOLDERMON, gMonFrontPic_Placeholdermon),
    SPECIES_SPRITE(VOLTREL, gMonFrontPic_Voltrel),
    SPECIES_SPRITE(VOLTREAN, gMonFrontPic_Voltrean),
    ...
    SPECIES_SPRITE(KROLUCADA, gMonFrontPic_Krolucada),
    SPECIES_SPRITE(KROLUCARD, gMonFrontPic_Krolucard),
