const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(DUNDRAG, gMonBackPic_Dundrag),
    SPECIES_SPRITE(DUNLONG, gMonBackPic_Dunlong),
    ...
    SPECIES_SPRITE(KUJINOUGHT, gMonBackPic_Kujinought),
    ...
    SPECIES_SPRITE(CORSOREEF, gMonBackPic_Corsoreef),
    ...
    SPECIES_SPRITE(GEKOPON, gMonBackPic_Gekopon),
    SPECIES_SPRITE(PLACEHOLDERMON, gMonBackPic_Placeholdermon),
    SPECIES_SPRITE(VOLTREL, gMonBackPic_Voltrel),
    SPECIES_SPRITE(VOLTREAN, gMonBackPic_Voltrean),
    ...
    SPECIES_SPRITE(KROLUCADA, gMonBackPic_Krolucada),
    SPECIES_SPRITE(KROLUCARD, gMonBackPic_Krolucard),
