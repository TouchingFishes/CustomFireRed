const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(DUNDRAG, gMonPalette_Dundrag),
    SPECIES_PAL(DUNLONG, gMonPalette_Dunlong),
    ...
    SPECIES_PAL(KUJINOUGHT, gMonPalette_Kujinought),
    ...
    SPECIES_PAL(CORSOREEF, gMonPalette_Corsoreef),
    ...
    SPECIES_PAL(GEKOPON, gMonPalette_Gekopon),
    SPECIES_PAL(PLACEHOLDERMON, gMonPalette_Placeholdermon),
    SPECIES_PAL(VOLTREL, gMonPalette_Voltrel),
    SPECIES_PAL(VOLTREAN, gMonPalette_Voltrean),
    ...
    SPECIES_PAL(KROLUCADA, gMonPalette_Krolucada),
    SPECIES_PAL(KROLUCARD, gMonPalette_Krolucard),
