const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_DUNDRAG] = gMonFootprint_Dundrag,
    [SPECIES_DUNLONG] = gMonFootprint_Dunlong,
    ...
    [SPECIES_KUJINOUGHT] = gMonFootprint_Kujinought,
    [SPECIES_MLLOY] = gMonFootprint_Mlloy,
    [SPECIES_BITEMARE] = gMonFootprint_Bitemare,
    [SPECIES_GEMGEIST] = gMonFootprint_Gemgeist,
    [SPECIES_TOXIBRO] = gMonFootprint_Toxibro,
    [SPECIES_GEOWATT] = gMonFootprint_Geowatt,
    [SPECIES_CLODSIRE] = gMonFootprint_Clodsire,
    [SPECIES_CURSOLA] = gMonFootprint_Cursola,
    [SPECIES_CORSOREEF] = gMonFootprint_Corsoreef,
    ...
    [SPECIES_GEKOPON] = gMonFootprint_Gekopon,
    [SPECIES_PLACEHOLDERMON] = gMonFootprint_Placeholdermon,
    [SPECIES_VOLTREL] = gMonFootprint_Voltrel,
    [SPECIES_VOLTREAN] = gMonFootprint_Voltrean,
    ...
    [SPECIES_KROLUCADA] = gMonFootprint_Krolucada,
    [SPECIES_KROLUCARD] = gMonFootprint_Krolucard,
