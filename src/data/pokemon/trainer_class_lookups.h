const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_INTERVIEWER]            = TRAINER_PIC_IRIS,
    [FACILITY_CLASS_BARRY]                  = TRAINER_PIC_BARRY,
    [FACILITY_CLASS_PAXTON]                 = TRAINER_PIC_PAXTON,
    ...
    [FACILITY_CLASS_PALMER]                 = TRAINER_PIC_PALMER,
    ...
    [FACILITY_CLASS_CYNTHIA]                = TRAINER_PIC_CYNTHIA,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BARRY]                  = TRAINER_CLASS_BARRY,
    [FACILITY_CLASS_PAXTON]                 = TRAINER_CLASS_PAXTON,
    ...
    [FACILITY_CLASS_PALMER]                 = TRAINER_CLASS_PALMER,
    ...
    [FACILITY_CLASS_CYNTHIA]                = TRAINER_CLASS_CYNTHIA,
