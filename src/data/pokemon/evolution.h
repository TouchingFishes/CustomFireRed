const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MURKROW]    = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_HONCHKROW}},
    [SPECIES_SNEASEL]    = {{EVO_FRIENDSHIP, 0, SPECIES_WEAVILE}},
    [SPECIES_GLIGAR]     = {{EVO_FRIENDSHIP, 0, SPECIES_GLISCOR}},
    [SPECIES_STANTLER]   = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_WYRDEER}},
    ...
    [SPECIES_DOUBLADE]   = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_AEGISLASH}},
