const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_DUNDRAG] = sDundragLevelUpLearnset,
    [SPECIES_DUNLONG] = sDunlongLevelUpLearnset,
    ...
    //TBD
    [SPECIES_KUJINOUGHT] = sKujinoughtLevelUpLearnset,
    [SPECIES_MLLOY] = sMlloyLevelUpLearnset,
    [SPECIES_BITEMARE] = sBitemareLevelUpLearnset,
    [SPECIES_GEMGEIST] = sGemgeistLevelUpLearnset,
    [SPECIES_TOXIBRO] = sToxibroLevelUpLearnset,
    [SPECIES_GEOWATT] = sGeowattLevelUpLearnset,
    [SPECIES_CLODSIRE] = sClodsireLevelUpLearnset,
    [SPECIES_CURSOLA] = sCursolaLevelUpLearnset,
    [SPECIES_CORSOREEF] = sCorsoreefLevelUpLearnset,
    ...
    [SPECIES_GEKOPON] = sGekoponLevelUpLearnset,
    [SPECIES_PLACEHOLDERMON] = sPlaceholdermonLevelUpLearnset,
    [SPECIES_VOLTREL] = sVoltrelLevelUpLearnset,
    [SPECIES_VOLTREAN] = sVoltreanLevelUpLearnset,
    ...
    [SPECIES_KROLUCADA] = sKrolucadaLevelUpLearnset,
    [SPECIES_KROLUCARD] = sKrolucardLevelUpLearnset,
