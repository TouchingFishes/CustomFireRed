...
static const u16 sEasyChatWordsByLetter_F[] = {
    ...
    EC_WORD_FLATTEN,
    EC_MOVE(FLATTER),
    EC_POKEMON2(FLETCHINDER), //Fletchinder is called Dartignis so this placement is techincally false
    EC_POKEMON2(FLETCHLING),
    EC_POKEMON2(FLITTLE),
    EC_WORD_FLOWERS,
    EC_MOVE(FLY),
    EC_POKEMON2(FLYGON),
...
static const u16 sEasyChatWordsByLetter_K[] = {
    ...
    EC_POKEMON(KOFFING),
    EC_POKEMON(KRABBY),
    EC_POKEMON2(KROLUCADA),
    EC_POKEMON2(KROLUCARD),
    EC_WORD_KTHX_BYE,
    EC_POKEMON2(KUJINOUGHT),
    EC_POKEMON2(KYOGRE),
};
...
static const u16 sEasyChatWordsByLetter_T[] = {
    ...
    EC_WORD_TIME,
    EC_WORD_TIMES,
    EC_POKEMON2(TINKATINK),
    EC_POKEMON2(TINKATON),
    EC_POKEMON2(TINKATUFF),
    EC_WORD_TIRED,
    EC_WORD_TO,
    EC_WORD_TO_HER,
    EC_WORD_TO_ME,
...
static const u16 sEasyChatWordsByLetter_V[] = {
    EC_WORD_VACATION,
    EC_POKEMON2(VANILLISH),
    EC_POKEMON2(VANILLITE),
    EC_POKEMON2(VANILLUXE),
    EC_POKEMON(VAPOREON),
    EC_POKEMON(VENOMOTH),
    EC_POKEMON(VENONAT),
    EC_POKEMON(VENUSAUR),
    ...
    EC_MOVE(VITAL_THROW),
    EC_POKEMON2(VOLBEAT),
    EC_POKEMON2(VOLCARONA),
    EC_WORD_VOLT_ABSORB,
    EC_MOVE2(VOLT_TACKLE),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(VOLTORB),
    EC_POKEMON(VOLTORB),
    EC_POKEMON2(VOLTREAN),
    EC_POKEMON2(VOLTREL),
    EC_WORD_VORACIOUS,
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(VULPIX),
