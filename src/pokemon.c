...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(DUNDRAG),
    SPECIES_TO_HOENN(DUNLONG),
    ...
    SPECIES_TO_HOENN(KUJINOUGHT),
    SPECIES_TO_HOENN(MLLOY),
    SPECIES_TO_HOENN(BITEMARE),
    SPECIES_TO_HOENN(GEMGEIST),
    SPECIES_TO_HOENN(TOXIBRO),
    SPECIES_TO_HOENN(GEOWATT),
    SPECIES_TO_HOENN(CLODSIRE),
    SPECIES_TO_HOENN(CURSOLA),
    SPECIES_TO_HOENN(CORSOREEF),
    ...
    SPECIES_TO_HOENN(GEKOPON),
    SPECIES_TO_HOENN(PLACEHOLDERMON),
    SPECIES_TO_HOENN(VOLTREL),
    SPECIES_TO_HOENN(VOLTREAN),
    ...
    SPECIES_TO_HOENN(KROLUCADA),
    SPECIES_TO_HOENN(KROLUCARD),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(DUNDRAG),
    SPECIES_TO_NATIONAL(DUNLONG),
    ...
    SPECIES_TO_NATIONAL(KUJINOUGHT),
    SPECIES_TO_NATIONAL(MLLOY),
    SPECIES_TO_NATIONAL(BITEMARE),
    SPECIES_TO_NATIONAL(GEMGEIST),
    SPECIES_TO_NATIONAL(TOXIBRO),
    SPECIES_TO_NATIONAL(GEOWATT),
    SPECIES_TO_NATIONAL(CLODSIRE),
    SPECIES_TO_NATIONAL(CURSOLA),
    SPECIES_TO_NATIONAL(CORSOREEF),
    ...
    SPECIES_TO_NATIONAL(GEKOPON),
    SPECIES_TO_NATIONAL(PLACEHOLDERMON),
    SPECIES_TO_NATIONAL(VOLTREL),
    SPECIES_TO_NATIONAL(VOLTREAN),
    ...
    SPECIES_TO_NATIONAL(KROLUCADA),
    SPECIES_TO_NATIONAL(KROLUCARD),
...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(DUNDRAG),
    HOENN_TO_NATIONAL(DUNLONG),
    ...
    HOENN_TO_NATIONAL(KUJINOUGHT),
    HOENN_TO_NATIONAL(MLLOY),
    HOENN_TO_NATIONAL(BITEMARE),
    HOENN_TO_NATIONAL(GEMGEIST),
    HOENN_TO_NATIONAL(TOXIBRO),
    HOENN_TO_NATIONAL(GEOWATT),
    HOENN_TO_NATIONAL(CLODSIRE),
    HOENN_TO_NATIONAL(CURSOLA),
    HOENN_TO_NATIONAL(CORSOREEF),
    ...
    HOENN_TO_NATIONAL(GEKOPON),
    HOENN_TO_NATIONAL(PLACEHOLDERMON),
    HOENN_TO_NATIONAL(VOLTREL),
    HOENN_TO_NATIONAL(VOLTREAN),
    ...
    HOENN_TO_NATIONAL(KROLUCADA),
    HOENN_TO_NATIONAL(KROLUCARD),
...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    //multiscale halves dmg for full hp
    if(defender->hp == defender->maxHP && defender->ability == ABILITY_MULTISCALE)
        damage /= 2;
