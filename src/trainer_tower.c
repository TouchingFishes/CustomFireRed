...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_TUBER_F,        FACILITY_CLASS_BARRY,               MALE}, 
    {OBJ_EVENT_GFX_TUBER_M_LAND,   FACILITY_CLASS_PAXTON,              MALE},
    ...
    {OBJ_EVENT_GFX_BEAUTY,         FACILITY_CLASS_PALMER,              MALE},
    ...
    {OBJ_EVENT_GFX_YOUNGSTER,      FACILITY_CLASS_CYNTHIA,           FEMALE},
...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[105] = {
    ...
    {FACILITY_CLASS_CYNTHIA,                TRAINER_ENCOUNTER_MUSIC_INTENSE},
    ...
    {FACILITY_CLASS_BARRY,                  TRAINER_ENCOUNTER_MUSIC_INTERVIEWER},
    ...
    {FACILITY_CLASS_PALMER,                 TRAINER_ENCOUNTER_MUSIC_FEMALE},
    ...
    {FACILITY_CLASS_PAXTON,                 TRAINER_ENCOUNTER_MUSIC_GIRL},
